...
import 'schema/video_requests_record.dart';
import 'schema/dm_requests_record.dart';
...
export 'schema/video_requests_record.dart';
export 'schema/dm_requests_record.dart';
...
/// Functions to query VideoRequestsRecords (as a Stream and as a Future).
Future<int> queryVideoRequestsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      VideoRequestsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<VideoRequestsRecord>> queryVideoRequestsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      VideoRequestsRecord.collection,
      VideoRequestsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<VideoRequestsRecord>> queryVideoRequestsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query DmRequestsRecords (as a Stream and as a Future).
Future<int> queryDmRequestsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DmRequestsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DmRequestsRecord>> queryDmRequestsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      DmRequestsRecord.collection,
      DmRequestsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DmRequestsRecord>> queryDmRequestsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Stream<List<CommissionsRecord>> queryCommissionsRecord({
  ...
  bool singleRecord = false,
    ...
    queryCollection(
      CommissionsRecord.collection,
      CommissionsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );
