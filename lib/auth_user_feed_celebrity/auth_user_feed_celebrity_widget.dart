...
import 'auth_user_feed_celebrity_model.dart';
export 'auth_user_feed_celebrity_model.dart';

class AuthUserFeedCelebrityWidget extends StatefulWidget {
  const AuthUserFeedCelebrityWidget({super.key});

  @override
  State<AuthUserFeedCelebrityWidget> createState() =>
      _AuthUserFeedCelebrityWidgetState();
}

class _AuthUserFeedCelebrityWidgetState
    extends State<AuthUserFeedCelebrityWidget> {
  late AuthUserFeedCelebrityModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthUserFeedCelebrityModel());
  }
