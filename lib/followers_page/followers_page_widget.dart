...
import 'followers_page_model.dart';
export 'followers_page_model.dart';

class FollowersPageWidget extends StatefulWidget {
  const FollowersPageWidget({super.key});

  @override
  State<FollowersPageWidget> createState() => _FollowersPageWidgetState();
}

class _FollowersPageWidgetState extends State<FollowersPageWidget> {
  late FollowersPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FollowersPageModel());
