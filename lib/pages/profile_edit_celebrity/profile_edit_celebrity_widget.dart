...
import 'profile_edit_celebrity_model.dart';
export 'profile_edit_celebrity_model.dart';

class ProfileEditCelebrityWidget extends StatefulWidget {
  const ProfileEditCelebrityWidget({super.key});

  @override
  State<ProfileEditCelebrityWidget> createState() =>
      _ProfileEditCelebrityWidgetState();
}

class _ProfileEditCelebrityWidgetState
    extends State<ProfileEditCelebrityWidget> {
  late ProfileEditCelebrityModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileEditCelebrityModel());
    ...
    _model.yourHandleTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.socialMediaHandle, ''));
      ...
      appBar: AppBar(
        ...
        title: Text(
          FFLocalizations.of(context).getText(
            'qnol84n1' /* Apply as a celebrity now */,
          ),
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            child: AuthUserStreamWidget(
                              builder: (context) => FlutterFlowDropDown<String>(
                                ...
                                options: [
                                  ...
                                  FFLocalizations.of(context).getText(
                                    'j4nouvn7' /* Sportsman/woman */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    '2vuez4ap' /* Content creator */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    'nccy9boo' /* TV/Radio show */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    'jc0b0e2d' /* Others */,
                                  ),
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'ep61vmh7' /* Where is your largest followin... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'lmyeos35' /* What is your largest following... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                            ...
                            child: AuthUserStreamWidget(
                              builder: (context) => FlutterFlowDropDown<String>(
                                controller: _model.followersValueController ??=
                                    FormFieldController<String>(
                                  _model.followersValue ??= valueOrDefault(
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'ss7l01bw' /* Your social media account hand... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  16.0, 24.0, 16.0, 0.0),
                              child: FFButtonWidget(
                                onPressed: ((_model.displanameTextController
                                                    .text ==
                                                '') ||
                                        ...
                                        (_model.myBioTextController.text ==
                                                '') ||
                                        (_model.largestFollowingValue == null ||
                                            _model.largestFollowingValue ==
                                                '') ||
                                        ((_model.yourHandleFocusNode?.hasFocus ?? false) ==
                                            null) ||
                                        (_model.followersValue == null ||
                                            _model.followersValue == '') ||
                                        (_model.yourCountryTextController.text ==
                                                '') ||
                                        (_model.uploadedFileUrl == '') ||
                                    ...
                                    : () async {
                                        ...
                                        await currentUserReference!
                                          ...
                                          email: _model.specializationValue,
                                        ));
